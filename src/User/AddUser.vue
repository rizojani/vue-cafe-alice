      ...
      >
        <div class="card p-2 mt-1">
          ...
          <div class="row mt-2 align-items-center">
            <div class="col-sm-4 col-lg-3">
              <p class="black p_sm ml-1">Last Name<span class="red">*</span></p>
            </div>
            <div class="col-lg-4 col-sm-8">
              <ValidationProvider
                name="last_name"
          ...
          <div class="row mt-2 align-items-center">
            <div class="col-sm-4 col-lg-3">
              <p class="black p_sm ml-1">Password<span class="red">*</span></p>
            </div>
            <div class="col-lg-4 col-sm-8">
              <ValidationProvider
                name="password"
          ...
          <div class="row mt-2 align-items-center">
            ...
            <div class="col-lg-4 col-sm-8">
              <ValidationProvider
                ...
                rules="required"
              >
                <input type="text" class="w-100" name="phone" v-model="phone" />
                <div class="text-danger">{{ errors[0] }}</div>
              </ValidationProvider>
            </div>
          </div>
